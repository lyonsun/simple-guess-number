...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1398094570, '1', './data/template/1_1_common_header_plugin_guest_number.tpl.php', './template/default', 'common/header_plugin_guest_number')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1398094570, '1', './data/template/1_1_common_header_plugin_guest_number.tpl.php', './template/default', 'common/header_plugin_guest_number')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1398094570, '1', './data/template/1_1_common_header_plugin_guest_number.tpl.php', './template/default', 'common/header_plugin_guest_number')
;?>
